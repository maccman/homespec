...
SHOTS = [
    ...
    ((-1.85, 17.30, 1.60), (-0.10, 0.995, 0.035), 0.65),
    # Final gallery review: center the actual headboard/art from the same clear standing point.
    ((-1.40, 26.53, 1.58), (0.011258947, 0.996929034, -0.077496696), 0.55),
    ((-6.30, 27.55, 1.60), (-0.43, 0.90, -0.09), 0.55),
    ((6.6, 6.25, 4.95), (-0.48, -0.86, -0.12), 0.8),
    ((6.2, 1.4, 4.85), (-0.42, 0.90, 0.13), 0.8),
    ((-4.25, 9.15, 4.87), (0.57, 0.82, -0.07), 0.75),
    ((-1.60, 25.85, 4.93), (-0.81, 0.58, -0.09), 0.65),
