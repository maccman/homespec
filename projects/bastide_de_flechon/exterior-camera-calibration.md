...
Current opening holdout RMS remains **pool46 83.23 px; courtyard08 103.91 px; kitchen12 4.30 px; front41 8.83 px**. The hall roof holdout remains **15.15 px** at native ridge 7379.93 mm. The unresolved main front roof holdout remains **125.83 px** at ridge 8508.83 mm. East oculus heights still produce approximately 97 and 127 pixels of vertical disagreement. These measurements describe this historical integrated checkpoint. Its subsequent saved-scene checks are recorded in `exterior-verification.md`.


## Current production-generation reprojection — 2026-09-05T22:09:17.833772+00:00

The final metadata refresh of `exterior-current-landmarks.json` uses source **55a3069** and exact native generation **e3b0760284354eac9ea110ca7e12ec92**, with IR SHA-256 `c5ae2d0418beefc946656622791043ea0ceb73c1bfe6e262ee174ed5369f1171`. The source freeze changes observed finishes and foreground planting after draft review. All 39 opening landmarks were independently re-derived from the production IR. Their world coordinates, four primary camera records, original UVs/weights and all residuals are exactly equal to the preceding integrated checkpoint. Both independent roof holdouts are also unchanged. The earlier integrated JSON remains at `out/exterior-study/exterior-landmarks-c48bda1fad184c5080dbc425b1566a7a.json`.

The complete camera-register SHA-256 remains `c120f2c07e4440c1cccde7022e654e98ee938f8489fb81304aed8c7f4d0ac8c7`. Current opening holdout RMS remains **pool46 83.23 px; courtyard08 103.91 px; kitchen12 4.30 px; front41 8.83 px**. The hall ridge holdout remains **15.15 px**, and the unresolved main ridge holdout remains **125.83 px**. The east oculus height disagreement also remains. No camera/register or project Python file was edited during this refresh. Production saved-scene and output validation are pending; these landmark calculations do not establish rendered-image acceptance.
