...
The deployed Site uses source commit `681487ddf1f4a82eb1873b9a2e805ac52b917e2f`, tree `57bf52e9904b52088e63087ba73a1cca4f8e1309`. [Publication receipt](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/site-publication.json) · [Deployed HTTP verification](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/site-public-http.json) · [Archive verification](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/site-archive-verification.json). HTTP verification covers all image previews, all 89 download headers and initial byte ranges, one complete full-resolution image hash, additional range cases and model exclusion; it does not claim every remote full file was streamed. The original verification HTML bytes are preserved, with Cloudflare adding its standard challenge script after them. No browser interaction was used for QA.
...
The website provides **54 full-resolution JPEG exports: 8-bit RGB, quality 96, 4:4:4 chroma sampling, with no resize, crop or reframing**. Exported dimensions match each source render; JPEG encoding changes the file format and pixel values, not the composition. The original 16-bit PNGs remain local and are not the website download format. The [frozen export manifest](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/site-jpeg-fallback/manifest.json), SHA-256 `f74e33bc85ce8b16bba6ba82dffb2499dff8a87a676ca608bcd3ab7106e964fe`, records all 54 source/export hashes, unchanged PNG bytes, dimensions and successful JPEG decoding.

Local masters: [Room PNGs](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/gallery) · [Interior comparisons](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/photo-comparison) · [Exterior PNGs](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/exterior) · [Interior details](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/details) · [Web-asset provenance](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/comparison-assets/provenance.json).

The retained v5 interior camera lock and exterior register are unchanged. Gallery/navigation view 11 changes only its look direction to include the bedroom's bed and artwork; position, 24 mm lens, geometry and photograph locks remain unchanged. [Framing record](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/bookmark-framing-change.json). Historical baseline images keep their own source/camera provenance.

All **61 cached original photographs match the supplied ZIP bytes**, and the **12 current comparison-pair mappings** are retained. The separate [original-photo audit](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/original-photo-audit.json) passed 128 checks. Web derivatives are distinct from the unchanged original-photo downloads.
...
The **local-only** [portable ZIP](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/La-Bastide-de-Flechon-Walkthrough.zip) is **315,328,619 bytes**, with all 18 members checked for CRC, exact bytes and permissions. Its model contains **64 saved embedded image datablocks**, no external textures, **26 tested bookmarks, ten Eevee previews and three light probes**. Three zero-user image blocks in the 67-image source are absent from the portable save; the pack log's 67 is a pre-save count. [Portable audit](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/portable-final-package-audit.json) · [Package SOURCE.json](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/SOURCE.json).

Extract the ZIP and keep the folder together. With Blender 5.2.1 installed, open **Walk Bastide.command** on macOS; elsewhere run `blender house_walk.blend --python walk_ui.py` from that folder. The Flechon sidebar offers room shortcuts and **Walk from here**. The launcher retains executable mode `0755`. See [README reproduction and controls](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/README.md).

## Verification and retained limits

- [Whole delivery: 3,408 assertions](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/deliverables/artifact-verification.json); [independent local audit: 966 assertions](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/final-independent-audit.json). Their scopes overlap; do not add their counts into a new result.
- [Visual review: 54 of 54](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/final-visual-review.json). Inspection used full-frame review derivatives, with original 16-bit PNG hashes/dimensions checked separately; it is not a claim of exact photographic likeness.
...
- The [current native report](/Users/cloud/.codex/worktrees/49bf/homespec/out/bastide_de_flechon/generations/9340bb88d26d4244a5364682e8d81807/report.json) retains **55 architectural clash records**. The [saved dressed-scene checks](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/scene-validation-summary.json) retain **46 unfiltered findings: 43 inside-wall and three guest-bedroom door-route reports**. These are different scopes, not zero-clash or whole-house clearance results.
...
- Roof/oculus heights, courtyard terrace levels, door states, tight approaches, regular rubble, simplified planting, inferred furnishings and material/light differences remain documented. [Exterior discrepancies](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/exterior-discrepancies.md) · [Interior discrepancies](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/photo-discrepancies.md). Older mesh-contact sampling remains attributed to its own frozen scene.

The exterior manifests retain one timing discrepancy: setup-time `lighting.actual_lights` contains a stale SUN matrix, while the hash-bound `effective_settings` recorded immediately before rendering has the correct SUN direction in all ten frames. [Reconciliation evidence](/Users/cloud/.codex/worktrees/49bf/homespec/out/final-delivery/exterior-light-snapshot-reconciliation.json) establishes the latter as the render-state record; maximum direction error is `1.798e-7`. Original manifests and pixels remain unchanged.

To repeat the local whole-delivery check from the repository root without changing dependencies:

```sh
FLECHON_ACKNOWLEDGE_EXISTING_GLAZING=1 \
  .venv/bin/python projects/bastide_de_flechon/verify_delivery.py --images-only
```

The [preserved earlier README](/Users/cloud/.codex/worktrees/49bf/homespec/projects/bastide_de_flechon/README-review-history.md) and focused study reports keep their original source hashes, findings and isolated-study omissions. They do not replace this completed local release record.
