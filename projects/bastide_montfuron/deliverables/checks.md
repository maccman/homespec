...
| PASS | glazing_ratio | living | 0.36 | 0.1 | glass area / floor area | habitable rooms: glass area >= 10% of floor area (rule of thumb) |
| PASS | glazing_ratio | dining | 0.42 | 0.1 | glass area / floor area | habitable rooms: glass area >= 10% of floor area (rule of thumb) |
...
| PASS | glazing_ratio | bed1 | 0.815 | 0.1 | glass area / floor area | habitable rooms: glass area >= 10% of floor area (rule of thumb) |
| PASS | glazing_ratio | bed2 | 0.497 | 0.1 | glass area / floor area | habitable rooms: glass area >= 10% of floor area (rule of thumb) |
...
| PASS | opening_fits_wall | D1 | 5800+1900 of 13500; head 3250 of 6400 | None |  |  |
...
| PASS | opening_fits_wall | N18 | 3000+1000 of 7000; head 5700 of 6400 | None |  |  |
...
| PASS | setbacks | building | x -3000..33000, y -5000..8050 | {'front': 10000.0, 'side': 8000.0, 'rear': 8000.0} | front = -y, rear = +y; parcel bounds used | footprint inside parcel less setbacks |
...
| PASS | stair_proportions | ST0 | riser 167, going 300, 2R+G 633 | 150..190 / >=250 / 550..700 |  | risers 150 to 190, going >= 250, 2R + G between 550 and 700 (rule of thumb) |
...
| PASS | stair_reaches_floor | ST0 | 2000.0 | 2000.0 | LP -> L0 |  |
| PASS | ids | Walls declare whether they are external | 21/21 pass | all |  | IDS 1.0 |
...
| PASS | ids | Ifcwall carries its homespec id and tags | 21/21 pass | all |  | IDS 1.0 |
