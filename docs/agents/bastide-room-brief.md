...
- hall: x 0.5..7, y 0.5..7, z 0. Stair ST1 climbs the north wall from the west wall (x 0.5..5.9, y 6..7) to z 3.5, entered from the room over its first two treads, landing 1.1 m short of the east wall. Arch A0 to the living room in the east wall at y 2.95..4.55. Door D2 (steel screen, 3 m wide) in the south wall at x 2.25..5.25 to the terrace. Window N8 in the west wall at y 3.5..4.5. Pendant L3 at (3.75, 3.75).
